...
function Navbar() {
  return (
    <div className="bg-transparent flex flex-row top-10 xl:top-0 left-1 xl:left-0 fixed p-1 items-center ml-2 md:ml-24 md:mt-4 lg:ml-52 lg:mt-8 xl:ml-90 xl:px-4">
