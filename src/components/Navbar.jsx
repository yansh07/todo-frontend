...
function Navbar() {
  return (
    <div className="bg-[#060010] flex flex-row top-6 left-2 xl:left-0 fixed p-1 items-center md:ml-24 md:mt-4 lg:ml-52 lg:mt-8 xl:ml-92">
      {/* Brand & Greeting Section */}
      <div className="flex items-center space-x-16 md:space-x-60 xl:space-x-72">
        ...
        <div className="text-lg font-[satoshi] text-gray-200 md:text-xl xl:text-2xl ">
          <GreetingComponent />
        </div>
      </div>
